  ...
  render() {
    ...
    body.innerHTML = this.users.map(u => `
      <tr class="hover:bg-gray-50 transition-colors border-b border-gray-50 last:border-b-0">
        ...
        <td class="px-6 py-4 text-sm text-gray-600 font-medium whitespace-nowrap" data-label="Phone">${u.phone || 'N/A'}</td>

        <td class="px-6 py-4 font-bold text-sm whitespace-nowrap ${u.performance_score >= 70 ? 'text-green-600' : u.performance_score >= 40 ? 'text-yellow-600' : 'text-red-500'}" data-label="Score">
        ...
        <td class="px-6 py-4 text-right whitespace-nowrap" data-label="Actions">
